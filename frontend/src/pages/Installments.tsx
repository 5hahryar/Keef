  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-28">
              ...
              {installments.map((installment) => (
                <div key={installment.id} className="bg-white rounded-3xl p-5 shadow-card">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {installment.status !== 'paid' && (
                      <button
                        onClick={() => handlePayInstallment(installment.loan.id, installment.id)}
      ...
      <button
        ...
        className="fixed right-6 h-14 w-14 rounded-2xl bg-violet-600 text-white shadow-lg text-3xl flex items-center justify-center z-30 btn btn-ripple"
